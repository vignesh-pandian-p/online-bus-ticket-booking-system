...
(17, 3, 2, 'BusOwner', 20, 'Delhi', 'Surat', '2018-04-17', 0),
(21, 7, 3, 'BusOwner', 20, 'Tundla', 'Allahabad', '2018-04-17', 0);
...
(2, 3, 'Kanpur to Lucknow', 'Bus_ID', '2018-04-26', 'bus2.jpg', 'Runs daily except Tuesday\r\nA/C Bus', 'Kanpur', 'Lucknow', 'Kanpur Unnao Lucknow', '6:00 8:00 11:00', 2, 20, 10),
(3, 3, 'Delhi to Mumbai', 'BusOwner', '2018-04-26', 'bus3.jpg', 'Runs daily \r\nLowest fare among all', 'Delhi', 'Mumbai', 'Delhi Jaipur Udaipur Naidad Surat Mumbai', '3:00 5:00 7:00 12:00 18:00 20:00', 1, 30, 17),
(4, 5, 'Chennai to Bangolore', 'BusOwner', '2018-05-18', 'bus4.jpg', 'Runs only on Tuesday', 'Chennai', 'Bangolore', 'Chennai Kanchipuram Chittor Bangolore', '12:00 2:00 5:00 7:00', 6, 0, -2),
(5, 3, 'Chandigarh to Manali', 'BusOwner', '2019-06-03', 'bus5.jpg', 'Runs daily', 'Chandigarh', 'Manali', 'Chandigarh Panchkula Mandi Kullu Manali', '12:00 2:00 5:00 7:00 8:00', 0, 0, 0),
(6, 4, 'Agra to Mathura', 'BusOwner', '2018-04-26', 'bus1.jpg', 'Weekly', 'Agra', 'Mathura', 'Agra Mathura', '5:00 7:00', 0, 0, 0),
(7, 4, 'Delhi to Allahabad', 'Bus_ID', '2018-04-26', 'bus2.jpg', 'Runs Weekly', 'Delhi', 'Allahabad', 'Delhi Ghaziabad Aligarh Tundla Kanpur Fatehpur Allahabad', '12:00 2:00 5:00 7:00 8:00 9:00 10:00 11:00', 0, 10, 9),
(8, 3, 'Kanpur to Lucknow', 'Bus_ID', '2018-04-30', 'bus2.jpg', 'Runs daily except Tuesday\r\nA/C Bus', 'Kanpur', 'Lucknow', 'Kanpur Unnao Lucknow', '6:00 8:00 11:00', 0, 20, 10);
...
(7, 3, 'BusOwner', 'saraswat@gmail.com', '2018-03-19', 'Great Services', 'no'),
(8, 4, 'Saraswat', 'BusOwner@gmail.com', '2018-03-23', 'Good', 'no'),
(9, 2, 'Parteek', 'saraswat.BusOwner100@gmail.com', '2018-03-17', 'Good', 'no'),
(10, 2, 'vikas', 'iit2016058@iiita.ac.in', '2018-03-18', 'Keep Going', 'no'),
(11, 3, 'BusOwner', 'iit2016058@iiita.ac.in', '2018-03-18', 'Good', 'no'),
...
(2, 'BusOwner', 'saraswat', 'BusOwner', 'saraswat', 'saraswat.BusOwner100@gmail.com', '9457507662', 'user_default.jpg', 'admin'),
